if { $argc != 1 } {
	puts "The tcl requires the path of mcs file to be programmed"
} else {
	puts "Now it will load [lindex $argv 0] "
}
...
set_property PROGRAM.FILES [list [lindex $argv 0]] [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xcu280_u55c_0] 0]]
set_property PROGRAM.PRM_FILE {} [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xcu280_u55c_0] 0]]
...
create_hw_bitstream -hw_device [lindex [get_hw_devices xcu280_u55c_0] 0] [get_property PROGRAM.HW_CFGMEM_BITFILE [ lindex [get_hw_devices xcu280_u55c_0] 0]] 
program_hw_devices [lindex [get_hw_devices xcu280_u55c_0] 0]
refresh_hw_device [lindex [get_hw_devices xcu280_u55c_0] 0]
